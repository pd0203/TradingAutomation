...
def triple_rsi_strategy(latest, position, leverage, balance, total_trades, winning_trades, losing_trades):
    ...
    # Check conditions to close long position
        ...
        position = 0
        # Position Closed
        return 0, balance, total_trades, winning_trades, losing_trades
    ...
    # Check conditions to close short position
        ...
        # Position Closed
        return 0, balance, total_trades, winning_trades, losing_trades
    return position, balance, total_trades, winning_trades, losing_trades
...
def auto_trading_bot(symbol, interval, trading_type, position, leverage):
    ...
    while True:
        ...
        if trading_type == "triple_rsi":
            position, balance, total_trades, winning_trades, losing_trades = triple_rsi_strategy(latest, position, leverage, balance, total_trades, winning_trades, losing_trades)
        else:
            result = {"error": "Unknown trading type"}
